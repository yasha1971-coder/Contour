...
# -----------------------------
EPSILON = 0.70          # ε — базовый порог поля
DELTA   = 0.12          # δ — ширина жизненной зоны вокруг ε (±)
ETA     = 0.010         # η — шаг преобразования/эволюции
NOISE   = 0.10          # интенсивность внешнего шума в dphi
